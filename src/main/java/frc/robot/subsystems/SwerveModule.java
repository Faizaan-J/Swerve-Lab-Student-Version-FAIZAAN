...
public class SwerveModule {
    ...
    public void updateSim(double dt) {
         ...
         */
        double radius = wheelCircumference / (2 * Math.PI);
        driveVelocityMPS = driveAngularVelocity * radius;

        /***
         * How is position, velocity, and time related?
         */
        drivePositionMeters += driveVelocityMPS * dt; // i learned this from unity frfr
